...
export default function Container({ children, className = "" }: Props) {
  return (
    <div
      ...
      className={`w-95 h-145 flex flex-col bg-zinc-950 overflow-hidden border border-zinc-800 rounded-lg shadow-2xl bg-cover bg-center bg-no-repeat ${className} relative`}
    >
